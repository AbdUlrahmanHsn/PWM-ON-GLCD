...
#define CLCD_U8_DATA_PORT          DIO_PORTC
...
#define CLCD_U8_CTRL_PORT          DIO_PORTD

#define CLCD_U8_RS_PIN    		   DIO_PIN0
#define CLCD_U8_RW_PIN    		   DIO_PIN1
#define CLCD_U8_E_PIN    	 	   DIO_PIN2
